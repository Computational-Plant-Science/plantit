...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'plantit_web.apps.PlantITConfig',
    'taggit',
    'django_celery_beat',
    'channels',
    'simple_history',
...
ASGI_APPLICATION = 'plantit_web.asgi.application'
WSGI_APPLICATION = 'plantit_web.wsgi.application'
...
CACHEOPS = {
    'plantit_web.*': {'ops': 'get', 'timeout': 60 * 15},
}
