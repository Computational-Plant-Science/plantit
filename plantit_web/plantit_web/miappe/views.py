...
from plantit_web.miappe.models import EnvironmentParameter, Study, Investigation
...
def suggested_environment_parameters(request):
    with open("plantit_web/miappe/suggested_environment_parameters.yaml", 'r') as file:
...
def suggested_experimental_factors(request):
    with open("plantit_web/miappe/suggested_experimental_factors.yaml", 'r') as file:
