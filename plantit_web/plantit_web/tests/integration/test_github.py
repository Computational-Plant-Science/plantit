...
from plantit_web.github import GitHubClient, AsyncGitHubClient


class GithubTests(TestCase):
    def test_list_user_organizations(self):
        client = GitHubClient(settings.GITHUB_TOKEN)
        institutions = client.get_organizations('w-bonelli', settings.GITHUB_TOKEN)
    ...
    async def test_list_user_organizations_async(self):
        ...
        institutions = await client.list_user_organizations('w-bonelli', settings.GITHUB_TOKEN)
