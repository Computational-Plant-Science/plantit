...
scp -o StrictHostKeyChecking=no -r -P $SSH_PORT plantit "$SSH_USER@$SSH_HOST:$SSH_DIRECTORY/plantit"
scp -o StrictHostKeyChecking=no -r -P $SSH_PORT config "$SSH_USER@$SSH_HOST:$SSH_DIRECTORY/config"
